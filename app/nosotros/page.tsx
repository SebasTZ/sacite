...
import { Target, Eye, Heart, Calendar, Star, Shield, Award, Building } from "lucide-react"
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <span className="text-lg font-semibold text-primary">Desde 1962</span>
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
                  Comunidad Artística <span className="text-primary">SACITE PERÚ</span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Más de 60 años defendiendo los derechos de los artistas peruanos y promoviendo el desarrollo cultural
                  de nuestro país.
                </p>
              ...
              <div className="relative">
                <img src="/peruvian-artists-community-historical-photo.jpg" alt="Comunidad SACITE PERÚ" className="rounded-2xl shadow-2xl" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-l-4 border-l-primary shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-2xl font-bold text-primary">1962</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Fundación</h3>
                  <p className="text-muted-foreground">
                    Se funda SACITE como respuesta a la necesidad de defender los derechos de los artistas peruanos.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-secondary shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-2xl font-bold text-secondary">1985</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Reconocimiento Oficial</h3>
                  <p className="text-muted-foreground">
                    Obtención del reconocimiento oficial como entidad representativa de los artistas del Perú.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-accent shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Modernización de servicios y creación de plataforma digital para conectar artistas con clientes.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <Card className="text-center shadow-xl border-0 bg-gradient-to-br from-primary/5 to-primary/10">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Defender y promover los derechos laborales de los artistas peruanos, garantizando condiciones justas
              ...
              <Card className="text-center shadow-xl border-0 bg-gradient-to-br from-secondary/5 to-secondary/10">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Ser la organización líder en la defensa de los derechos artísticos, reconocida por su compromiso con
                    la excelencia y el desarrollo cultural del Perú.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center shadow-xl border-0 bg-gradient-to-br from-accent/5 to-accent/10">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-2">
                    {["Integridad", "Compromiso", "Excelencia", "Solidaridad"].map((value) => (
        ...
        <section className="py-20 bg-card/30">
          <div className="container-responsive">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Equipo Directivo</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { name: "Jorge Luis Condenamarin Niño", role: "Secretario General Nacional", image: "executive-1" },
                { name: "Jaqueline Moroni Flores", role: "Sub Secretaria General", image: "executive-2" },
                { name: "Pedro David Herrera", role: "Secretario de Organización", image: "executive-3" },
                {
                  name: "Emanuel Ita Maldonado Heredia",
                  role: "Secretario de Defensa y Trabajo",
                  image: "executive-4",
                },
                { name: "José Manuel Rebaza Rodriguez", role: "Secretario de Bienestar Social", image: "executive-5" },
                { name: "Imagen Elli Neri", role: "Secretario de Cultura", image: "executive-6" },
              ].map((member) => (
                <Card
                  key={member.name}
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div className="relative mb-4">
                      <img
                        src={`/abstract-geometric-shapes.png?height=120&width=120&query=${member.image} professional headshot`}
                        alt={member.name}
                    ...
                    <p className="text-xs text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity">
                      Comprometido con la defensa de los derechos artísticos y el desarrollo cultural del Perú.
                    </p>
                  </CardContent>
                </Card>
              ))}
